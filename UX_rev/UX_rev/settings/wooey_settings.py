...
if DJANGO_VERSION < DJ110:
    ...
    MIDDLEWARE_CLASSES.append('UX_rev.middleware.ProcessExceptionMiddleware')
    MIDDLEWARE_OBJ = MIDDLEWARE_CLASSES
else:
    # Using Django 1.10 +
    MIDDLEWARE = list(MIDDLEWARE)
    MIDDLEWARE.append('UX_rev.middleware.ProcessExceptionMiddleware')
...
NEW_MIDDLEWARE.append('UX_rev.middleware.ProcessExceptionMiddleware')
if DJANGO_VERSION < DJ110:
